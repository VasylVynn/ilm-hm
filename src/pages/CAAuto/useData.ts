...
export const useData = () => {
  ...
  const fetchProducts = () => {
    setIsLoading(true);
    axios.get('https://ca.wizz-app.net/api/sizes')
      .then(response => {
  ...
  function deleteProduct(articleCode: string) {
    axios.delete(`https://ca.wizz-app.net/api/sizes/${articleCode}`)
      .then(() => {
  ...
  const deleteAllProducts = () => {
    axios.delete('https://ca.wizz-app.net/api/sizes')
      .then(() => {
        // Refresh the product list
        fetchProducts();
      })
  ...
  const deleteProducts = () => {
    ...
    axios.delete(`https://ca.wizz-app.net/api/sizes/delete?region=${region}&category=${category}&reason=${reason}`)
      .then(() => {
        // Refresh the product list
        fetchProducts();
      })
